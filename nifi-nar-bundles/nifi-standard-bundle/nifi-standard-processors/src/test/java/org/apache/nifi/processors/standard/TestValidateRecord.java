...
public class TestValidateRecord {
    ...
    @Test
    public void testValidationForNullElementArray() throws Exception {
        ...
        runner.enqueue(Paths.get("src/test/resources/TestValidateRecord/array-with-null-element.avro"));
        runner.run();
